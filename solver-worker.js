/* BOXXY v130 Rust/WebAssembly solver worker.
 *
 * External engine: dangarfield/sokoban-solver, festival-rust browser build.
 *
 * v130 avoids both forms which proved unreliable in Opera/GitHub Pages:
...
function compileBinding(bindingSource) {
  ...
  // v130 always passes WASM bytes explicitly and never uses that fallback.

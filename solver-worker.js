 ...
 */
/* BOXXY v141 Rust/WebAssembly solver worker.
 *
 * External engine: dangarfield/sokoban-solver, festival-rust browser build.
 *
 * v141 retains the approach that avoids both forms which proved unreliable in Opera/GitHub Pages:
...
function compileBinding(bindingSource) {
  ...
  // v141 continues to pass WASM bytes explicitly and never uses that fallback.

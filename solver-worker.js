 ...
 */
/* BOXXY v137 Rust/WebAssembly solver worker.
 *
 * External engine: dangarfield/sokoban-solver, festival-rust browser build.
 *
 * v137 avoids both forms which proved unreliable in Opera/GitHub Pages:
...
function compileBinding(bindingSource) {
  ...
  // v137 always passes WASM bytes explicitly and never uses that fallback.
